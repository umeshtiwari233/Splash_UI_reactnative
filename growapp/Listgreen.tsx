...
export default class Listgreen extends Component {
  render() {
    ...
    return (
      <View style={styles.main}>
        ...
        <Text  style={{color:'#2ed573',fontSize:13,marginTop:4}}>{last}</Text>
        <Text style={{ marginLeft:-1,fontSize:18,marginTop:-2,color:'#2ed573',fontWeight:'600'}}>{vlast}</Text>
        </View>
      </View>
    )
  }
